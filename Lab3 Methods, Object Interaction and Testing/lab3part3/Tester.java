public class Tester {
	...
	public static void testPart3() {
		...
		System.out.println("======");
		 ...
		 System.out.println("Creating a new Door to Nowhere with no lock");  
		 System.out.println("Setting the room name of the Door to Research Labs");
		 Door door = new Door();
		 ...
		 door.attachLock(lock); 
		  ...
		  System.out.println("Create a new student/staff SmartCard");
		  SmartCard cardA= new SmartCard("Anna Undergrad");
		  SmartCard cardB= new SmartCard("Dr.Bob Lecturer");
		  cardB.setStaff(true);
		 ...
		 System.out.println("Last card seen: " + lock.getLastCardSeen().getOwner() + "'s card");
		 System.out.println();
		 System.out.println("Swipe the student SmartCard on the CardLock");
		  
		  System.out.println("Swipe the student SmartCard on the CardLock");
		  System.out.println("* Swiping " + cardA.getOwner() + "'s card");
		  System.out.println();
		  System.out.println("Try to open the Door.");
		  System.out.println("Is the Door lock unlocked?"+ lock.isUnlocked());
		  System.out.println();
